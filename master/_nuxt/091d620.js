(window.webpackJsonp=window.webpackJsonp||[]).push([[1],Array(121).concat([function(t,e){t.exports=function(n){n.options.__i18n=n.options.__i18n||[],n.options.__i18n.push(`{"fr":{"tableOfContents":"Table des mati\xE8res","functional-presentation":"Pr\xE9sentation fonctionnelle","interoperate":"Interop\xE9rer","technical-architecture":"Architecture technique","user-guide-backoffice":"Manuel utilisateur back-office","user-guide-frontoffice":"Manuel utilisateur front-office","constructionWarning":"Cette page est en chantier et les informations qu'elle contient peuvent ne pas \xEAtre \xE0 jour.","install":"Installation et configuration","onlyEnglish":"Cette page est disponible uniquement en anglais.","onlyFrench":null}}`),delete n.options._Ctor}},function(t,e){t.exports=function(n){n.options.__i18n=n.options.__i18n||[],n.options.__i18n.push('{"en":{"tableOfContents":"Table of contents","functional-presentation":"Functional presentation","interoperate":"Interoperate","technical-architecture":"Technical architecture","user-guide-backoffice":"User guide back-office","user-guide-frontoffice":"User guide front-office","constructionWarning":"This page is in construction and the information it contains can be outdated.","install":"Install and configure","onlyEnglish":null,"onlyFrench":"This page is only available in french for the time being"}}'),delete n.options._Ctor}},,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,function(t,e,n){"use strict";n.r(e);var i=function(){var s=this,q=s.$createElement,f=s._self._c||q;return f("v-list",{attrs:{dense:"",expand:""}},[s._l(s.chapters,function(y,l){return[f("v-list-group",{key:y.id,attrs:{"no-action":"",value:l===0}},[f("v-list-item",{attrs:{slot:"activator",to:s.localePath({name:y.id}),nuxt:"",exact:""},slot:"activator"},[f("v-list-item-title",[s._v(`
        ...
        `)])],1),s._v(" "),s._l(s.content.filter(function(u){return u.chapter===y.id&&!u.subsection}),function(u){return[s.content.filter(function(c){return c.chapter===y.id&&c.section==u.section&&c.subsection}).length?f("v-list-group",{key:u.id,attrs:{"no-action":"","sub-group":""}},[f("v-list-item",{attrs:{slot:"activator",to:s.localePath({name:y.id+"-id",params:{id:u.id}}),nuxt:""},slot:"activator"},[f("v-list-item-title",[s._v(`
            ...
            `),u.published?s._e():f("v-icon",{attrs:{color:"error",small:""}},[s._v(`
              mdi-alert
            `)])],1)],1)]})],2)]})],2)},o=[],b=n(8),p=n(35),h=n(16),S=n(33),C=n(50),P=n(37),L=n(30),D=n(38),k=n(43),A=n(158),j=n(351),z={props:["folder"],computed:{content:function(){var q=this;if(!!this.$route){var f=n(353),y=f.keys().filter(function(l){return l.startsWith("./install")||l.startsWith("./interoperate")||l.startsWith("./technical-architecture")?!0:l.includes("-".concat(q.$i18n.locale,".md"))}).map(function(l){return Object.assign(j(f(l).default).meta||{},{chapter:l.split("/")[1],id:l.split("/")[2].split(".").shift().replace("-".concat(q.$i18n.locale),"")})}).filter(function(l){return l.published||!0});return y.sort(function(l,u){return q.chapters.findIndex(function(c){return c.id===l.chapter})<q.chapters.findIndex(function(c){return c.id===u.chapter})?-1:q.chapters.findIndex(function(c){return c.id===l.chapter})>q.chapters.findIndex(function(c){return c.id===u.chapter})?1:l.section&&!u.section?-1:!l.section&&u.section?1:l.section<u.section?-1:l.section>u.section?1:l.subsection&&!u.subsection?-1:!l.subsection&&u.subsection?1:l.subsection<u.subsection?-1:1}),y}},chapters:function(){return[{id:"functional-presentation",title:this.$t("functional-presentation")},{id:"user-guide-backoffice",title:this.$t("user-guide-backoffice")},{id:"user-guide-frontoffice",title:this.$t("user-guide-frontoffice")},{id:"technical-architecture",title:this.$t("technical-architecture")},{id:"interoperate",title:this.$t("interoperate")},{id:"install",title:this.$t("install")}]}}},w=z,v=n(47),m=n(169),d=n(170),g=n(65),I=n.n(g),E=n(162),x=n(163),F=n(166),a=n(103),V=n(45),r=Object(v.a)(w,i,o,!1,null,null,null);typeof m.default=="function"&&Object(m.default)(r),typeof d.default=="function"&&Object(d.default)(r);var T=e.default=r.exports;I()(r,{VIcon:E.a,VList:x.a,VListGroup:F.a,VListItem:a.a,VListItemTitle:V.b})},,,,,function(t,e,n){"use strict";var i=n(121),o=n.n(i);e.default=o.a},function(t,e,n){"use strict";var i=n(122),o=n.n(i);e.default=o.a},,function(t,e,n){"use strict";var i=n(1),o=n(0);n(161),i.a.use(n(638),{moment:o})},,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,function(t,e,n){},,function(t,e,n){},,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,function(t,e,n){"use strict";var i=function(){var a=this,V=a.$createElement,r=a._self._c||V;return r("v-app",[r("v-navigation-drawer",{attrs:{app:"",fixed:"",width:"300"}},[r("v-list-item",{attrs:{to:a.localePath({name:"index"}),nuxt:"",exact:""}},[r("v-list-item-avatar",{staticClass:"brand-logo"},[r("v-img",{attrs:{src:"./logo.png"}})],1),a._v(" "),r("v-list-item-content",[r("v-list-item-title",{staticClass:"text-h5 font-weight-bold"},[a._v(`
          Data Fair
        `)])],1)],1),a._v(" "),r("v-divider"),a._v(" "),r("folder-menu")],1),a._v(" "),r("v-main",[r("v-speed-dial",{attrs:{direction:"bottom",transition:"fade-transition",absolute:"",top:"",right:""},scopedSlots:a._u([{key:"activator",fn:function(){return[r("v-btn",{staticStyle:{"font-weight":"bold"},attrs:{icon:"",color:"primary"}},[a._v(`
          `+a._s(a.$i18n.locale)+`
        `)])]},proxy:!0}])},[a._v(" "),a._l(a.$i18n.locales.filter(function(T){return T!==a.$i18n.locale}),function(T){return r("v-btn",{key:T,staticStyle:{"font-weight":"bold"},attrs:{to:a.switchLocalePath(T),icon:"",nuxt:""}},[a._v(`
        `+a._s(T)+`
      `)])})],2),a._v(" "),r("nuxt")],1),a._v(" "),r("v-footer",{staticClass:"pa-3"},[r("v-spacer"),a._v(" "),r("div",[a._v("Maintained by "),r("a",{attrs:{href:"https://koumoul.com"}},[a._v("Koumoul")])])],1)],1)},o=[],b=n(164),p={components:{FolderMenu:b.default}},h=p,S=n(619),C=n(47),P=n(65),L=n.n(P),D=n(650),k=n(642),A=n(651),j=n(652),z=n(350),w=n(103),v=n(165),m=n(45),d=n(653),g=n(656),I=n(654),E=n(655),x=Object(C.a)(h,i,o,!1,null,null,null),F=e.a=x.exports;L()(x,{FolderMenu:n(164).default}),L()(x,{VApp:D.a,VBtn:k.a,VDivider:A.a,VFooter:j.a,VImg:z.a,VListItem:w.a,VListItemAvatar:v.a,VListItemContent:m.a,VListItemTitle:m.b,VMain:d.a,VNavigationDrawer:g.a,VSpacer:I.a,VSpeedDial:E.a})},function(t,e,n){"use strict";var i=function(){var j=this,z=j.$createElement,w=j._self._c||z;return w("v-app",[w("v-main",[w("nuxt")],1)],1)},o=[],b={},p=b,h=n(631),S=n(47),C=n(65),P=n.n(C),L=n(650),D=n(653),k=Object(S.a)(p,i,o,!1,null,null,null),A=e.a=k.exports;P()(k,{VApp:L.a,VMain:D.a})},,,,function(t,e,n){var i={"./about/overview-fr.md":355,"./functional-presentation/access-control-en.md":356,"./functional-presentation/access-control-fr.md":357,"./functional-presentation/analitycs-en.md":358,"./functional-presentation/analitycs-fr.md":359,"./functional-presentation/api-en.md":360,"./functional-presentation/api-fr.md":361,"./functional-presentation/api-key-en.md":362,"./functional-presentation/api-key-fr.md":363,"./functional-presentation/api-stats-en.md":364,"./functional-presentation/api-stats-fr.md":365,"./functional-presentation/back-office-en.md":366,"./functional-presentation/back-office-fr.md":367,"./functional-presentation/catalog-en.md":368,"./functional-presentation/catalog-fr.md":369,"./functional-presentation/connection-en.md":370,"./functional-presentation/connection-fr.md":371,"./functional-presentation/connectors-en.md":372,"./functional-presentation/connectors-fr.md":373,"./functional-presentation/content-pages-en.md":374,"./functional-presentation/content-pages-fr.md":375,"./functional-presentation/dataset-details-en.md":376,"./functional-presentation/dataset-details-fr.md":377,"./functional-presentation/dataset-management-en.md":378,"./functional-presentation/dataset-management-fr.md":379,"./functional-presentation/extensions-en.md":380,"./functional-presentation/extensions-fr.md":381,"./functional-presentation/home-en.md":382,"./functional-presentation/home-fr.md":383,"./functional-presentation/introduction-en.md":384,"./functional-presentation/introduction-fr.md":385,"./functional-presentation/licenses-en.md":386,"./functional-presentation/licenses-fr.md":387,"./functional-presentation/notify-en.md":388,"./functional-presentation/notify-fr.md":389,"./functional-presentation/periodic-processings-en.md":390,"./functional-presentation/periodic-processings-fr.md":391,"./functional-presentation/portal-config-en.md":392,"./functional-presentation/portal-config-fr.md":393,"./functional-presentation/portal-en.md":394,"./functional-presentation/portal-fr.md":395,"./functional-presentation/portal-notify-en.md":396,"./functional-presentation/portal-notify-fr.md":397,"./functional-presentation/portal-publication-en.md":398,"./functional-presentation/portal-publication-fr.md":399,"./functional-presentation/user-management-en.md":400,"./functional-presentation/user-management-fr.md":401,"./functional-presentation/visu-config-en.md":402,"./functional-presentation/visu-config-fr.md":403,"./functional-presentation/visualization-en.md":404,"./functional-presentation/visualization-fr.md":405,"./functional-presentation/visualizations-page-en.md":406,"./functional-presentation/visualizations-page-fr.md":407,"./install/config.md":408,"./install/install.md":409,"./interoperate/api.md":410,"./interoperate/applications.md":411,"./interoperate/collectors.md":412,"./interoperate/connectors.md":413,"./interoperate/services.md":414,"./technical-architecture/analytics.md":415,"./technical-architecture/backup.md":416,"./technical-architecture/capture.md":417,"./technical-architecture/connectors.md":418,"./technical-architecture/data-fair.md":419,"./technical-architecture/http-log.md":420,"./technical-architecture/introduction.md":421,"./technical-architecture/notify.md":422,"./technical-architecture/portal.md":423,"./technical-architecture/processings.md":424,"./technical-architecture/simple-directory.md":425,"./technical-architecture/thumbor.md":426,"./user-guide-backoffice/add-reuse-en.md":427,"./user-guide-backoffice/add-reuse-fr.md":428,"./user-guide-backoffice/analytics-en.md":429,"./user-guide-backoffice/analytics-fr.md":430,"./user-guide-backoffice/api-en.md":431,"./user-guide-backoffice/api-fr.md":432,"./user-guide-backoffice/attachements-en.md":433,"./user-guide-backoffice/attachements-fr.md":434,"./user-guide-backoffice/bar-chart-race-en.md":435,"./user-guide-backoffice/bar-chart-race-fr.md":436,"./user-guide-backoffice/carto-stats-en.md":437,"./user-guide-backoffice/carto-stats-fr.md":438,"./user-guide-backoffice/catalogues-en.md":439,"./user-guide-backoffice/catalogues-fr.md":440,"./user-guide-backoffice/catchment-area-en.md":441,"./user-guide-backoffice/catchment-area-fr.md":442,"./user-guide-backoffice/charts-en.md":443,"./user-guide-backoffice/charts-fr.md":444,"./user-guide-backoffice/concept-en.md":445,"./user-guide-backoffice/concept-fr.md":446,"./user-guide-backoffice/content-en.md":447,"./user-guide-backoffice/content-fr.md":448,"./user-guide-backoffice/dashboard-en.md":449,"./user-guide-backoffice/dashboard-fr.md":450,"./user-guide-backoffice/datasets-en.md":451,"./user-guide-backoffice/datasets-fr.md":452,"./user-guide-backoffice/div-admin-en.md":453,"./user-guide-backoffice/div-admin-fr.md":454,"./user-guide-backoffice/edition-dataset-en.md":455,"./user-guide-backoffice/edition-dataset-fr.md":456,"./user-guide-backoffice/enrichment-en.md":457,"./user-guide-backoffice/enrichment-fr.md":458,"./user-guide-backoffice/file-formats-en.md":459,"./user-guide-backoffice/file-formats-fr.md":460,"./user-guide-backoffice/game-localisation-en.md":461,"./user-guide-backoffice/game-localisation-fr.md":462,"./user-guide-backoffice/game-quizz-en.md":463,"./user-guide-backoffice/game-quizz-fr.md":464,"./user-guide-backoffice/game-sort-en.md":465,"./user-guide-backoffice/game-sort-fr.md":466,"./user-guide-backoffice/geo-shapes-en.md":467,"./user-guide-backoffice/geo-shapes-fr.md":468,"./user-guide-backoffice/import-dataset-en.md":469,"./user-guide-backoffice/import-dataset-fr.md":470,"./user-guide-backoffice/infos-localisations-en.md":471,"./user-guide-backoffice/infos-localisations-fr.md":472,"./user-guide-backoffice/infos-parcelles-en.md":473,"./user-guide-backoffice/infos-parcelles-fr.md":474,"./user-guide-backoffice/licences-thematics-en.md":475,"./user-guide-backoffice/licences-thematics-fr.md":476,"./user-guide-backoffice/liste-fiches-en.md":477,"./user-guide-backoffice/liste-fiches-fr.md":478,"./user-guide-backoffice/members-en.md":479,"./user-guide-backoffice/members-fr.md":480,"./user-guide-backoffice/menu-en.md":481,"./user-guide-backoffice/menu-fr.md":482,"./user-guide-backoffice/navigation-en.md":483,"./user-guide-backoffice/navigation-fr.md":484,"./user-guide-backoffice/network-en.md":485,"./user-guide-backoffice/network-fr.md":486,"./user-guide-backoffice/organisation-en.md":487,"./user-guide-backoffice/organisation-fr.md":488,"./user-guide-backoffice/parameter-reuse-en.md":489,"./user-guide-backoffice/parameter-reuse-fr.md":490,"./user-guide-backoffice/parameters-en.md":491,"./user-guide-backoffice/parameters-fr.md":492,"./user-guide-backoffice/periodic-series-en.md":493,"./user-guide-backoffice/periodic-series-fr.md":494,"./user-guide-backoffice/portal-en.md":495,"./user-guide-backoffice/portal-fr.md":496,"./user-guide-backoffice/processing-en.md":497,"./user-guide-backoffice/processing-fr.md":498,"./user-guide-backoffice/proportion-en.md":499,"./user-guide-backoffice/proportion-fr.md":500,"./user-guide-backoffice/relations-en.md":501,"./user-guide-backoffice/relations-fr.md":502,"./user-guide-backoffice/reuses-carto-en.md":503,"./user-guide-backoffice/reuses-carto-fr.md":504,"./user-guide-backoffice/reuses-en.md":505,"./user-guide-backoffice/reuses-fr.md":506,"./user-guide-backoffice/reuses-game-en.md":507,"./user-guide-backoffice/reuses-game-fr.md":508,"./user-guide-backoffice/reuses-graphics-en.md":509,"./user-guide-backoffice/reuses-graphics-fr.md":510,"./user-guide-backoffice/reuses-text-en.md":511,"./user-guide-backoffice/reuses-text-fr.md":512,"./user-guide-backoffice/sankey-en.md":513,"./user-guide-backoffice/sankey-fr.md":514,"./user-guide-backoffice/sigin-en.md":515,"./user-guide-backoffice/sigin-fr.md":516,"./user-guide-backoffice/sunburst-en.md":517,"./user-guide-backoffice/sunburst-fr.md":518,"./user-guide-backoffice/update-dataset-en.md":519,"./user-guide-backoffice/update-dataset-fr.md":520,"./user-guide-backoffice/webhooks-en.md":521,"./user-guide-backoffice/webhooks-fr.md":522,"./user-guide-backoffice/word-cloud-en.md":523,"./user-guide-backoffice/word-cloud-fr.md":524,"./user-guide-frontoffice/contentpage-en.md":525,"./user-guide-frontoffice/contentpage-fr.md":526,"./user-guide-frontoffice/datapage-en.md":527,"./user-guide-frontoffice/datapage-fr.md":528,"./user-guide-frontoffice/datasetpage-en.md":529,"./user-guide-frontoffice/datasetpage-fr.md":530,"./user-guide-frontoffice/homepage-en.md":531,"./user-guide-frontoffice/homepage-fr.md":532,"./user-guide-frontoffice/use-portal-en.md":533,"./user-guide-frontoffice/use-portal-fr.md":534,"./user-guide-frontoffice/visualisation-en.md":535,"./user-guide-frontoffice/visualisation-fr.md":536,"./user-guide-frontoffice/visualisationspage-en.md":537,"./user-guide-frontoffice/visualisationspage-fr.md":538};function o(p){var h=b(p);return n(h)}function b(p){if(!n.o(i,p)){var h=new Error("Cannot find module '"+p+"'");throw h.code="MODULE_NOT_FOUND",h}return i[p]}o.keys=function(){return Object.keys(i)},o.resolve=b,t.exports=o,o.id=353},,function(t,e,n){"use strict";n.r(e),e.default=`Data Fair permet d'enrichir et de partager facilement ses donn\xE9es pour pouvoir ensuite les utiliser dans des applications. Le partage des donn\xE9es peut se faire en mode priv\xE9 (private data) ou public (open data). Les donn\xE9es partageables sont des donn\xE9es de type tabulaire ou g\xE9ographiques. Data Fair permet de mettre facilement des donn\xE9es \xE0 disposition, mais les m\xE9tadonn\xE9es sont minimes et **ce n'est donc pas un service de catalogage**. Il peut donc \xEAtre un excellent compl\xE9ment \xE0 un service comme [udata](https://github.com/opendatateam/udata) utilis\xE9 sur le site [data.gouv.fr](http://data.gouv.fr).
...
Data Fair permet de contr\xF4ler **simplement mais de mani\xE8re puissante** les permissions sur les diff\xE9rentes ressources. Les utilisateurs peuvent faire partie de une ou plusieurs organisations, qui peuvent elles m\xEAme contenir un ou plusieurs utilisateurs.  
Quand un utilisateur configure un jeux de donn\xE9es ou une application, il peut d\xE9terminer quels utilisateurs et organisations y ont **acc\xE8s**. Ouvrir un acc\xE8s \xE0 une organisation donne l'acc\xE8s \xE0 tous les membres de cette organisation. Les acc\xE8s peuvent \xE9galement \xEAtre **ouverts en public** et m\xEAme les personnes non authentifi\xE9es pourront alors acc\xE9der \xE0 la ressource.

Les utilisateurs et organisations ne sont pas g\xE9r\xE9es dans ce service. Pour gerer les utilisateurs et organisation, Data Fair doit \xEAtre connect\xE9 \xE0 un annuaire qui impl\xE9mente le contrat du service d'identification **Simple-Directory**.
`},function(t,e,n){"use strict";n.r(e),e.default=`---
title: Contr\xF4les d'acc\xE8s
section: 3
subsection : 13
updated: 2020-12-09
description : Contr\xF4les d'acc\xE8s
published: true
---
...
Les utilisateurs et organisations ne sont pas g\xE9r\xE9es dans ce service. Pour gerer les utilisateurs et organisation, Data Fair doit \xEAtre connect\xE9 \xE0 un annuaire qui impl\xE9mente le contrat du service d'identification [Simple-Directory](https://github.com/koumoul-dev/simple-directory).
`},function(t,e,n){"use strict";n.r(e),e.default=`---
...
L\u2019ensemble des fonctionnalit\xE9s de la gestion des donn\xE9es, du catalogage, de la gestion des utilisateurs et des statistiques est disponible au travers d\u2019**API Rest document\xE9es**.  
...
Un autre avantage d\u2019utiliser cette sp\xE9cification est l\u2019**interop\xE9rabilit\xE9** accrue, certains syst\xE8mes informatiques (par exemple les API gateway)  \xE9tant capable de comprendre cette sp\xE9cification.


![API](./images/functional-presentation/api.jpg)


Les diff\xE9rentes utilisations possibles de l'API sont d\xE9crites plus en d\xE9tails dans [cette section](./interoperate/api).

Il est possible d'utiliser l'API pour **moissonner les donn\xE9es d'un portail**. Par exemple, le site https://www.opendatarchives.fr/ moissonne r\xE9guli\xE8rement les donn\xE9es du portail https://data.ademe.fr/ propuls\xE9 par Data Fair.
`},function(t,e,n){"use strict";n.r(e),e.default=`---
title: API keys
section: 3
subsection : 11
...
![Cl\xE9 d'api](./images/functional-presentation/ajout-api.jpg)
...
subsection : 11
updated: 2020-12-09
description : Cl\xE9s d\u2019API
published: true
---


Toutes les fonctionnalit\xE9s de Data Fair sont expos\xE9es aux niveaux de l'API. Celle ci peut \xEAtre appel\xE9e en dehors du portail, mais pour les acc\xE8s restreints il faut passer par l'utilisation d'une **cl\xE9 d'API**. Les diff\xE9rentes utilisations possibles de l'API sont d\xE9crites plus en d\xE9tails dans [cette section](./interoperate/api).

![Cl\xE9 d'api](./images/functional-presentation/ajout-api.jpg)

Lors de l\u2019ajout d\u2019une cl\xE9 d\u2019api, il est possible de restreindre l\u2019acc\xE8s \xE0 une seule fonction. Il est ensuite possible de restreindre l\u2019acc\xE8s \xE0 une IP ou \xE0 un nom de domaine pr\xE9cis.
`},function(t,e,n){"use strict";n.r(e),e.default=`---
...
`},function(t,e,n){"use strict";n.r(e),e.default=`---
title: Catalogue de donn\xE9es
section: 2
subsection : 2
updated: 2020-12-09
description : Catalogue de donn\xE9es
published: true
---
...
Une fois connect\xE9 les utilisateurs peuvent personnaliser leur compte.

Il est possible de :
* d\xE9finir un avatar
* d\xE9finir le pr\xE9nom et le pr\xE9nom  
* d\xE9finir la date d'anniversaire
* renouveler le mot de passe
* relier son compte \xE0 un compte github, linkedin, google ou facebook
* visualiser les diff\xE9rentes organisations de son compte et le r\xF4le pour chacune des organisations
* visualiser le nombre d'organisation cr\xE9\xE9es et le nombre d'organisation maximale pour le compte.
* cr\xE9er une nouvelle organisation
...
En plus de la saisie de texte libre, il est possible d'int\xE9grer diff\xE9rents type d'\xE9l\xE9ments : tableau d'un jeu de donn\xE9es, visualisation, liste de jeux de donn\xE9es, int\xE9gration de contenu externe, ...
...
published: true
---
Pour pouvoir \xEAtre accessibles au plus grand nombre, les jeux de donn\xE9es sont pr\xE9sent\xE9s avec des **visualisations adapt\xE9es aux donn\xE9es**. Les visiteurs du portail peuvent rapidement s\u2019impr\xE9gner des donn\xE9es et **interagir** avec elles.

Diff\xE9rents outils permettent \xE0 un public plus averti de pouvoir aller plus loin (t\xE9l\xE9chargement, utilisation de l\u2019API, partage, acc\xE8s aux m\xE9tadonn\xE9es, ...)

![D\xE9tails d'un jeu de donn\xE9es](./images/functional-presentation/detail-1.jpg)

La vignette d\u2019informations pr\xE9sente le producteur des donn\xE9es, la licence associ\xE9e, la date de derni\xE8re mise \xE0 jour ainsi que diff\xE9rents boutons d\u2019actions. Ces actions sont les m\xEAmes que celles sur les vignettes du catalogue de donn\xE9es, avec en plus la possibilit\xE9 de **t\xE9l\xE9charger les donn\xE9es**.

En dessous du titre et de la description des donn\xE9es, les visualisations associ\xE9es au jeu de donn\xE9es sont pr\xE9sent\xE9es avec leur description, ce qui permet de **donner du sens \xE0 ses donn\xE9es**, de raconter une histoire et de mettre en avant diff\xE9rents aspects du jeu de donn\xE9es ou des cas d\u2019utilisations possibles.

Les visualisations sont **interactives** et il est possible d\u2019acc\xE9der \xE0 la page de la visualisation en cliquant sur son titre.

![Page de pr\xE9sentation d'un jeu de donn\xE9es](./images/functional-presentation/detail-2.jpg)

En bas de page, diff\xE9rents boutons permettent de partager la page du jeu de donn\xE9es sur les r\xE9seaux sociaux (Facebook, Twitter, Linkedin, \u2026). La page de donn\xE9es poss\xE8de des **m\xE9tadonn\xE9es enrichies** qui permettent une meilleure indexation par les moteurs de recherche et un affichage d\u2019une miniature sur les r\xE9seaux sociaux. Cette miniature pr\xE9sente la premi\xE8re visualisation associ\xE9e au jeu de donn\xE9es, et ce c\xF4t\xE9 graphique permet d\u2019**augmenter l\u2019engagement** des utilisateurs des r\xE9seaux sociaux.

![Miniature jeu de donn\xE9es](./images/functional-presentation/detail-3.jpg)

Il est possible de t\xE9l\xE9charger une partie du jeu de donn\xE9es filtr\xE9. L\u2019interface de t\xE9l\xE9chargement est actuellement en cours d\u2019am\xE9lioration pour int\xE9grer la possibilit\xE9 de t\xE9l\xE9charger les donn\xE9es dans une grande vari\xE9t\xE9 de formats (CSV, TSV, XLS, TXT,GeoJson,\u2026), ainsi que les pi\xE8ces jointes associ\xE9es au jeu de donn\xE9es.
`},function(t,e,n){"use strict";n.r(e),e.default=`---
...
`},function(t,e,n){"use strict";n.r(e),e.default=`---
title: Gestion des jeux de donn\xE9es
section: 3
subsection : 2
updated: 2020-12-09
description : Gestion des jeux de donn\xE9es
published: false
---

Les jeux de donn\xE9es sont repr\xE9sent\xE9s sous formes de fiches sur la plateforme. Une fiche poss\xE8de un titre et des informations relatives aux donn\xE9es. Les informations comprennent le nom du fichier, sa taille, le nombre de lignes et les th\xE9matiques des donn\xE9es. L'ic\xF4ne du propri\xE9taire des donn\xE9es et l\u2019\xE9tat de publication sont aussi disponibles sur chaque fiche.

![Fiche d'un jeu de donn\xE9es](./images/functional-presentation/jeu-2.jpg)

### Types de donn\xE9es

Il existe plusieurs types de jeux de donn\xE9es sur la plateforme, les fichiers, les jeux de donn\xE9es incr\xE9mentaux, les jeux de donn\xE9es virtuels.

* Les **jeux de donn\xE9es fichiers** correspondent \xE0 des donn\xE9es sous format tabulaire ou cartographique charg\xE9s sur la plateforme. Plusieurs formats de fichiers sont support\xE9s tels que le CSV, TSV, XLS, TXT,GeoJson, KML, ESRI Shapefile, \u2026

* Les **jeux de donn\xE9es incr\xE9mentaux** sont des donn\xE9es stock\xE9es en base et sont plut\xF4t adapt\xE9s \xE0 des donn\xE9es qui \xE9voluent r\xE9guli\xE8rement. Ils sont mis \xE0 jour par API et sont bien adapt\xE9s pour des donn\xE9es IOT par exemple.
...
### Ajout d\u2019un jeu de donn\xE9es
Il est possible d'importer diff\xE9rentes sources de donn\xE9es sur Data Fair. On peut d\xE9j\xE0 importer des fichiers directement depuis son ordinateur. Il sera bient\xF4t possible d'importer des donn\xE9es depuis des sources externes comme Airtable ou Google drive.

Une fois les donn\xE9es charg\xE9es, elles sont converties dans un format plus standard en interne, puis analys\xE9es automatiquement pour d\xE9terminer le sch\xE9ma du jeu de donn\xE9es. Les donn\xE9es sont ensuite index\xE9es puis \xE9ventuellement enrichies avec d'autres donn\xE9es externes. Des derniers traitements sont effectu\xE9s pour calculer des propri\xE9t\xE9s li\xE9es aux donn\xE9es (cardinalit\xE9s des champs, bornes g\xE9ographiques, ...) puis le jeu de donn\xE9es est disponible pour pouvoir \xEAtre \xE9dit\xE9 ou utilis\xE9.

Apr\xE8s cette \xE9tape, les donn\xE9es sont consultables \xE0 minima dans un tableau et sont triables et filtrable. Si les concepts de **Latitude** et **Longitude** sont renseign\xE9s dans le sch\xE9ma, les donn\xE9es sont aussi consultable dans une carte. Si elles ont un concept **Images**, une galerie est g\xE9n\xE9r\xE9e.

### Edition d\u2019un jeu de donn\xE9es

La page d\u2019\xE9dition d\u2019un jeu de donn\xE9es permet de travailler la pr\xE9sentation et la r\xE9utilisabilit\xE9 de ce jeu. Cette page permet de modifier le titre du jeu de donn\xE9es, mettre \xE0 jour les donn\xE9es, compl\xE9ter le sch\xE9ma des donn\xE9es, s\xE9mantiser les donn\xE9es pour qu'elles soient r\xE9utilisables dans des visualisations ou pour pouvoir \xEAtre enrichies via des services compl\xE9mentaires.

#### Sch\xE9ma des donn\xE9es

La page d'\xE9dition d'un jeu de donn\xE9es permet, entre autres, de renseigner les concepts dans la section **Sch\xE9ma des donn\xE9es**.  
Les concepts sont des notions connues pour la plateforme. Ils permettent d'**augmenter la r\xE9utilisabilit\xE9** de vos donn\xE9es et de faire le lien entre vos donn\xE9es et les fonctionnalit\xE9s de la plateforme.

![Sch\xE9ma d'un jeu de donn\xE9es](./images/functional-presentation/schema.jpg)


A l\u2019aide des concepts, vous pouvez par exemple **enrichir vos donn\xE9es** pour leur donner encore plus de valeur ou bien projeter vos donn\xE9es sur une carte.
Un concept est unique \xE0 une colonne d'un jeu de donn\xE9es. Vous ne pouvez pas avoir deux colonnes diff\xE9rentes avec le m\xEAme concept pour un jeu de donn\xE9es.

Les concepts sont n\xE9cessaires \xE0 la repr\xE9sentation de certaines visualisations. Par exemple, vos donn\xE9es ne pourront pas \xEAtre projet\xE9es sur une carte si vous n'avez pas associ\xE9 les concepts **Latitude** et **Longitude** aux colonnes qui contiennent les valeurs latitude et longitude.

Dans la section des **Sch\xE9ma de donn\xE9es**, on peut renseigner des libell\xE9s sur chacun des champs. Ces libell\xE9s sont utilis\xE9s dans la vue tableau et dans les diff\xE9rentes visualisations du jeu de donn\xE9es.

#### Enrichissement des donn\xE9es

Il est possible d'enrichir vos donn\xE9es avec des donn\xE9es issues de l'open data telles que la base **SIRENE**, le **cadastre**, les **donn\xE9es INSEE et la BAN**.  
* La base SIRENE rassemble les informations \xE9conomiques et juridiques de plus de 28 Millions d'\xE9tablissements d'entreprises, dont plus de 11 Millions actifs.
...
En fonction des donn\xE9es que vous poss\xE9dez, vous pouvez choisir l'enrichissement qui vous convient et ainsi donner plus de valeur \xE0 vos donn\xE9es.

#### Permissions de partage de donn\xE9es

Un administrateur peut contr\xF4ler finement les permissions d\u2019**acc\xE8s aux donn\xE9es**. En fonction du r\xF4le attribu\xE9 \xE0 un utilisateur, celui-ci \xE0 le droit d'acc\xE9der, de lire ou/et de modifier le contenu de la source.

![Persmissions d'un jeu de donn\xE9es](./images/functional-presentation/permissions.jpg)

On peut ainsi donner le r\xF4le d\u2019**user** \xE0 un groupe de personnes et d\xE9finir s\u2019ils peuvent acc\xE9der et lire une ressource de la plateforme.

Il est aussi possible de g\xE9rer les permissions plus finement et de donner les droits \xE0 un seul ou plusieurs utilisateurs. La liste des personnes ayant des permissions sur un jeu de donn\xE9es est disponible dans la page d\u2019\xE9dition de ce jeu.

#### Journal du jeu de donn\xE9es

Le journal d\u2019un jeu de donn\xE9es permet de v\xE9rifier l\u2019**historique des modifications** sur le jeu de donn\xE9es.

![Journal d'un jeu de donn\xE9es](./images/functional-presentation/journal.jpg)

Le journal permet la **tra\xE7abilit\xE9** des modifications des jeux de donn\xE9es, des param\xE8tres et des habilitations.

#### Pi\xE8ces jointes

Il est possible d\u2019associer des pi\xE8ces jointes \xE0 chaque ligne d\u2019un jeu de donn\xE9es. Cela se fait en associant une archive au format zip qui contient les fichiers \xE0 associer. Il faut aussi qu\u2019il y ait dans le jeu de donn\xE9es une colonne contenant les noms des fichiers \xE0 associer \xE0 chaque ligne. Deux types de fichiers peuvent \xEAtre li\xE9s aux lignes : des images (png, jpg, \u2026) ou des documents (pdf, docx, xlsx, \u2026). Dans le cas des documents, ils sont index\xE9s **fulltext** par la plateforme et les recherches tiennent compte du contenu de ces documents.

Les pi\xE8ces jointes peuvent aussi \xEAtre directement attach\xE9es \xE0 un jeu de donn\xE9es. On peut par exemple ajouter des fichiers de documentation ou des m\xE9tadonn\xE9es riches.
`},function(t,e,n){"use strict";n.r(e),e.default=`---
title: Extensions
section: 4
updated: 2020-12-09
...
La soci\xE9t\xE9 Koumoul propose sous forme d'abonnement un certain nombre de **services distants** et de **visualisations de donn\xE9es** compatibles avec Data Fair (fonds de carte, base des entreprises de France, cadastre, base nationale des adresses, etc.).
`},function(t,e,n){"use strict";n.r(e),e.default=`---
title: Home page
section: 2
subsection : 1
...
![Th\xE9matiques](./images/functional-presentation/thematique.jpg)
...
subsection : 1
updated: 2020-12-09
description : Licences et th\xE9matiques
published: true
---

Une licence d\xE9finit les **droits** d'utilisation, de partage et d\u2019acc\xE8s aux donn\xE9es. Les th\xE9matiques permettent de mieux **cataloguer** les donn\xE9es. Data Fair permet de g\xE9rer simplement les listes de licences et th\xE9matiques dont vous avez besoin pour vos donn\xE9es.
...
Les licences et th\xE9matiques ajout\xE9es dans votre configuration peuvent ensuite \xEAtre assign\xE9es aux donn\xE9es. Les licences et th\xE9matiques de vos donn\xE9es seront ainsi consultables sur votre portail.
`},function(t,e,n){"use strict";n.r(e),e.default=`---
title: Alerts
section: 3
subsection : 10
...
Les utilisateurs enregistr\xE9s peuvent param\xE9trer diff\xE9rentes **alertes** email ou navigateur. Une liste d\u2019alertes par d\xE9faut est pr\xE9sent\xE9e dans la cat\xE9gorie **Notifications**.

![Activer ses notifications](./images/functional-presentation/notify-1.jpeg)

Lorsqu\u2019une notification est d\xE9clench\xE9e, une pastille color\xE9e est pr\xE9sente sur la cloche en haut \xE0 droite. Un clic sur la cloche permet d'acc\xE9der \xE0 un r\xE9sum\xE9 des alertes pr\xE9c\xE9demment envoy\xE9es.
...
Les traitements p\xE9riodiques se diff\xE9rencient des connecteurs de catalogues sur plusieurs points :
* Un traitement est limit\xE9 \xE0 un ensemble r\xE9duit de sources en entr\xE9e et en sortie. Typiquement il peut r\xE9cup\xE9rer des donn\xE9es \xE0 un endroit, et des m\xE9tadonn\xE9es \xE0 un autre, et d\xE9verser les donn\xE9es dans une source de la plateforme.
...
Les traitements p\xE9riodiques se configurent en renseignant le type de source (Donn\xE9es IOT, fichiers issus de facturation, \u2026), le jeu de donn\xE9es correspondant dans la plateforme et la fr\xE9quence de collecte.

![Collecteurs](./images/functional-presentation/collecteurs.jpg)


Il est \xE9galement possible d\u2019avoir l\u2019**\xE9tat de r\xE9ussite** du dernier traitement pour chaque collecteur, ainsi que d\u2019acc\xE9der \xE0 des logs d\xE9taill\xE9s des derni\xE8res collectes de donn\xE9es. Les traitements p\xE9riodiques peuvent aussi \xEAtre utilis\xE9s pour des mises \xE0 jour tous les jours, toutes les semaines, etc..

Il est possible de rajouter de **nouveaux traitements p\xE9riodiques** en suivant les instructions dans [cette section](./interoperate/collectors).
`},function(t,e,n){"use strict";n.r(e),e.default=`---
...
`},function(t,e,n){"use strict";n.r(e),e.default=`---
title: Configuration d\u2019un portail de donn\xE9es
section: 3
subsection : 4
updated: 2020-12-09
description : Configuration d\u2019un portail de donn\xE9es
published: true
---

La configuration du portail de donn\xE9es se fait de mani\xE8re **graphique** en deux temps : on travaille sur un brouillon que l'on publie ensuite en version courante. La *version courante* est la version qui est pr\xE9sent\xE9e aux diff\xE9rents visiteurs de votre portail, ce qui permet de mettre \xE0 jour le portail sans impacter les utilisateurs tant que l'on n'a pas valid\xE9 le brouillon.


![Configuration d'un portail](./images/functional-presentation/configuration-portail.jpg)


Quelques \xE9l\xE9ments de configuration : le logo, l\u2019image d'accueil, la favicon, la couleur de la barre de navigation, la couleur du footer, des \xE9l\xE9ments de contenu (titre, description, visualisation \xE0 mettre en avant, visibilit\xE9 publique ou priv\xE9e) et divers \xE9l\xE9ments de communication (site web, mail de contact et compte twitter)
...
`},function(t,e,n){"use strict";n.r(e),e.default=`---
title: Portail de donn\xE9es
section: 2
updated: 2020-12-09
description : Portail de donn\xE9es
published: true
---
...
Une **mire d\u2019authentification** est accessible sur toutes les pages du portail pour pouvoir se connecter ou cr\xE9er un compte. Le compte permet d'acc\xE9der aux donn\xE9es priv\xE9es selon ses droits dans le cas de portails interne, et s'abonner \xE0 des **notifications** sur les jeux de donn\xE9es.`},function(t,e,n){"use strict";n.r(e),e.default=`---
...
Les utilisateurs enregistr\xE9s peuvent **s'abonner** \xE0 l'ajout d'un jeu de donn\xE9es sur le portail ou dans une th\xE9matique en particulier :

![Notification](./images/functional-presentation/notifiy-pf-1.png)

Il est aussi possible de s'abonner \xE0 la mise \xE0 jour d'un jeu de donn\xE9es en particulier \xE0 l'aide de la cloche sur sa page de pr\xE9sentation.


![jeu de donnees](./images/functional-presentation/notifiy-pf-3.png)

Les alertes seront visibles sur la cloche de la barre de navigation et un **email d'alerte** sera envoy\xE9 sur l'adresse de votre compte.
...
`},function(t,e,n){"use strict";n.r(e),e.default=`---
title: Publier sur un portail de donn\xE9es
section: 3
subsection : 5
updated: 2020-12-09
description : Publier ses donn\xE9es et ses visualisations sur un portail de donn\xE9es
published: true
---

Les jeux de donn\xE9es et les visualisations que vous disposez dans votre back-office peuvent \xEAtre publi\xE9s sur **plusieurs portails.**  
Une fois les permissions sur vos donn\xE9es ou vos visualisations d\xE9finies, la sous-section **Portail** de la section **Partage** vous permet de choisir sur quel portail vous souhaitez publier vos ressources.  
Si vos donn\xE9es sont en acc\xE8s publique, elles peuvent \xEAtre publi\xE9es sur tous les portails disponibles. Si elle sont en acc\xE8s restreint, elles ne peuvent \xEAtre publi\xE9es que sur les portails avec authentification.
...
Les **super administrateurs** de la plateforme peuvent g\xE9rer l'ensemble des organisations et des membres de la plateforme. Ils peuvent aussi configurer le portail de donn\xE9es et g\xE9rer les traitements p\xE9riodiques.
...
Une personne peut appartenir \xE0 plusieurs organisations avec diff\xE9rents r\xF4les dans chaque organisation.
`},function(t,e,n){"use strict";n.r(e),e.default=`---
...
Les visualisations interactives permettent de pr\xE9senter les donn\xE9es de mani\xE8re ludique et qu'elles soient rapidement comprises. Elle sont servies par des applications Web l\xE9g\xE8res ([Cette section](./interoperate/applications) d\xE9crit en d\xE9tails la mani\xE8re de les cr\xE9er). Elles peuvent \xEAtre configur\xE9es gr\xE2ce \xE0 une interface graphique qui ne **requiert pas de comp\xE9tences en programmation**.
...
Un aper\xE7u donne un rendu de la visualisation. Lorsque l\u2019on r\xE9alise des modifications sur le menu de configuration, elles sont directement repr\xE9sent\xE9es sur l'aper\xE7u. Il est ainsi possible de modifier et tester rapidement diff\xE9rents rendus de la visualisation. Lorsque le rendu est satisfaissant, l\u2019enregistrement permet de valider les modifications r\xE9alis\xE9es. Les modifications sont alors visibles pour tous les utilisateurs de la visualsiation.

Par d\xE9faut, une visualisation est priv\xE9e. Elle peut \xEAtre rendue publique par la suite. Dans tous les cas, il est recommand\xE9 de renseigner une description. Cette description sera visible sur la page de consultation de la visualisation.

Data Fair offre une grande vari\xE9t\xE9 de visualisations en constante progression.

![Differentes visualisations](./images/functional-presentation/valorisations.jpg)

### Visualisations de type carte
* **Infos parcelles** : Projeter ses donn\xE9es sur le plan cadastral fran\xE7ais.
* **Infos localisations** : Projeter ses donn\xE9es g\xE9olocalis\xE9es et cr\xE9er des fiches sur chaque marqueur.
* **Divisions administratives** : Projeter ses donn\xE9es au niveau de la commune, du d\xE9partement, ou de la r\xE9gion.
* **Geo Shapes** : Projeter des donn\xE9es contenant des formes g\xE9om\xE9triques sur une carte.
...
* **Liste et fiches** : Cr\xE9er un moteur de recherche pour pouvoir explorer ses donn\xE9es sous formes de fiches.
...
`},function(t,e,n){"use strict";n.r(e),e.default=`---
title: Liste des visualisations de donn\xE9es
section: 2
subsection : 4
updated: 2020-12-09
description : Liste des visualisations de donn\xE9es
published: true
---
Tout comme pour les jeux de donn\xE9es, un catalogue des visualisations est disponible avec un **moteur de recherche** et des outils pour filtrer ou trier les visualisations.

Les visualisations sont pr\xE9sent\xE9es au travers de **vignettes imag\xE9es**. Comme pour les jeux de donn\xE9es, ces vignettes poss\xE8dent diff\xE9rents boutons d\u2019actions pour pouvoir **interagir** rapidement avec la visualisation ou naviguer vers une vue plein \xE9cran de celle-ci.  
Un clic sur le titre ou l\u2019image d\u2019une vignette permet de naviguer vers la page de d\xE9tails de la visualisation.
